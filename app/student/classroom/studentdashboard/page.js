    ...
    const menuItems = [
        {
            title: "Attendance",
            icon: FileText,
            link: "/student/classroom/studentdashboard/attendance",
        },
        {
            title: "Announcements",
            icon: Megaphone,
            link: "/student/classroom/studentdashboard/announcement",
        },
        {
            title: "Remarks",
            icon: FileText,
            link: "/student/classroom/studentdashboard/remarks",
        },
        {
            title: "Resources",
            icon: BookOpen,
            link: "/student/classroom/studentdashboard/resource",
        },
    ];

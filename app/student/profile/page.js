                ...
                <div className="md:max-w-5xl md:mx-auto md:space-y-10">
                    ...
                    <div className="md:bg-white md:p-6 md:rounded-2xl md:shadow-md md:border md:border-blue-100 md:space-y-6">
                        ...
                        <div className="flex flex-col gap-3 mt-8 md:flex-row md:justify-between md:gap-5">
                            ...
                            <button className="bg-red-500 text-white py-2 rounded-full cursor-pointer font-medium md:flex-1 md:py-3 hover:bg-red-600 transition" onClick={() => { sessionService.removeSession(); router.push("/login") }}>
                                Logout
                            </button>
                        </div>
                    </div>

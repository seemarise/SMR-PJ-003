                  ...
                  {comment.replies && comment.replies.length > 0 && (
                    <div className="mt-4 ml-4 space-y-3">
                      {comment.replies.map((reply) => (
                        <div key={reply.id} className="bg-gray-50 rounded-lg p-3 border-l-2 border-[#5074b6]">
                          ...
                          <p className="text-gray-800 text-sm leading-relaxed ml-10">
                            {reply.text}
                          </p>
                        </div>
                      ))}
                  ...
                  {replyingTo === comment.id && (
                    <div className="mt-4 ml-4 bg-gray-50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm text-gray-600">Replying to {comment.author}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 bg-white rounded-full px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-[#5074b6] transition border border-gray-200"
                          autoFocus
                        />
                        <button
        ...
        <footer className="fixed bottom-20 left-0 right-0 bg-white border-t border-gray-200 px-4 py-4 shadow-lg z-20">
          {editingComment ? (
            ...
            <div className="flex items-center gap-3 max-w-5xl mx-auto">
              ...
              <div className="flex-1">
                <div className="text-sm text-gray-600 mb-1">Replying to a comment</div>
                <input
                  type="text"
                  value={replyText}
                  onChange={(e) => setReplyText(e.target.value)}
                  onKeyPress={(e) => e.key === "Enter" && handleAddReply()}
                  placeholder="Write a reply..."
                  className="w-full bg-gray-100 rounded-full px-5 py-3 text-base outline-none focus:ring-2 focus:ring-[#5074b6] transition"
                  autoFocus
                />
              </div>
              <button

      ...
      <main className="flex-1 px-4 py-2 space-y-6 animate-in fade-in duration-300">
                ...
                <div className="mt-3 grid grid-cols-1 gap-2">
                  {(q.options || []).map((opt, oi) => {
                    ...
                    return (
                      <label
                        key={oi}
                        className={`flex items-center gap-3 p-2 rounded-md border cursor-pointer ${selected ? "border-blue-400 bg-white" : "border-gray-200 bg-white"
                          }`}
                      >
                        <input
                          type="radio"
        ...
        <div className="mt-6 flex gap-3 md:max-w-5xl md:mx-auto">
          <button
            ...
            className="flex-1 bg-white border border-gray-300 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-50 cursor-pointer"
          >
            Back to Compendium
          </button>
          <button
            ...
            className="flex-1 bg-blue-600 text-white rounded-lg py-2.5 text-sm font-medium hover:bg-blue-700 cursor-pointer"
          >
            Save
          </button>
        </div>

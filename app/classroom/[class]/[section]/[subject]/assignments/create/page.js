...
import { addAssignment, generateAssignment } from "@/services/classroomService/assignmentApi";
                            ...
                            {showQuestions && (
                                <div className="mt-3 p-3 border rounded-lg bg-gray-50 md:p-5 md:rounded-xl">
                                    <div className="flex justify-between items-center mb-2">
                                        <p className="font-medium">{MCQs.length} Questions</p>

                                    </div>

                                    <div className="flex gap-2 mt-3 flex-wrap">
                                        <button className="border px-3 py-2 rounded-lg text-sm hover:bg-gray-50 transition" onClick={() => { setOpenAIModal(true) }}>
                                            + Generate with AI
                                        </button>
                                        <button className="border px-3 py-2 rounded-lg text-sm hover:bg-gray-50 transition cursor-pointer" onClick={() => { setOpenQuestionModal(true) }}>
                                            + Add Questions
                                        </button>
                                    </div>
                                </div>

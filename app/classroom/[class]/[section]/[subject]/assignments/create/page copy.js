                ...
                <div className="md:max-w-5xl md:mx-auto md:space-y-10">
                    ...
                    <form className="space-y-4 md:space-y-6 bg-white rounded-lg shadow-sm p-4 md:p-8 md:rounded-xl">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            {topics.map(t => {
                                return <span className="px-3 py-2 bg-lime-300 rounded-md">{t} <button className="cursor-pointer hover:bg-grey-100" onClick={() => { setTopics(p => p.filter(x => x !== t)) }}>X</button></span>

...
export default function EditQuestionsPage() {
    ...
    const [tab, setTab] = useState("mcq"); // "mcq" or "descriptive"
    ...
    const handleAddQuestion = () => {
        if (tab === "mcq") {
            ...
            setDescQuestions([...descQuestions, { question: "", answer: "" }]);
    ...
    const handleSaveAndReturn = () => {
        console.log("Saved questions:", { mcqQuestions, descQuestions });
        router.back();
    };
            ...
            <main className="px-4 py-4 flex-1 md:px-8 md:py-10">
                ...
                <div className="md:max-w-5xl md:mx-auto md:space-y-10">
                    ...
                    <div className="w-full max-w-2xl bg-white shadow-md rounded-lg p-4 space-y-4 mx-auto md:p-6 md:rounded-xl">
                        ...
                        <div>
                            <label className="block font-semibold mb-1 text-gray-800">Question</label>
                            <textarea
                                ...
                                onChange={(e) => {
                                    ...
                                    isMcq ? setMcqQuestions(updated) : setDescQuestions(updated);
                                }}
                            />
                        </div>
                                        ...
                                        >
                                            <input
                                                ...
                                                onChange={() => {
                                                    ...
                                                    updated[currentIndex].correct = i;
                                                    setMcqQuestions(updated);
                                                }}
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    const updated = [...mcqQuestions];
                                                    updated[currentIndex].options[i] = e.target.value;
                                                    setMcqQuestions(updated);
                                                }}

                    ...
                    Object.keys(submissionInfo.submission).length !== 0 && (
                        <div className="md:max-w-5xl md:mx-auto md:space-y-10">
                            ...
                            <div className="relative flex items-center justify-between mb-6 md:mb-10">
                                ...
                                {/* Title Centered */}
                                <h1 className="absolute left-1/2 -translate-x-1/2 text-lg font-semibold text-[#5074b6] md:text-3xl md:font-bold text-center">
                                    {title}
                                </h1>
                            ...
                            <div className={`rounded-lg p-4 flex flex-col gap-2 mb-6 md:p-6 md:rounded-2xl md:shadow-sm ${statusStyles[submissionInfo.submission.approvalStatus]?.header
                                }`}>

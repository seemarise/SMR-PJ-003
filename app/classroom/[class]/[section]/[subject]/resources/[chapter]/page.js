...
export default function ChapterPage({ params }) {
  const { class: className, section, subject, chapter } = React.use(params);
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 w-[90%] max-w-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    className="px-5 py-2 rounded-xl bg-[#5074b6] text-white font-medium hover:bg-[#5d88d3] cursor-pointer"
                  >
                    Add Module
                  </button>
                </div>

...
import { ArrowLeft, RotateCw, Info, UserRound, Send, MessageSquarePlus } from "lucide-react";
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button className="self-end mt-2 text-[13px] text-gray-600 bg-gray-50 px-3 py-1 rounded-full border border-gray-100 flex items-center gap-1 md:text-sm hover:bg-gray-100 transition cursor-pointer" onClick={() => { router.push("./comment/reply?comment=" + c._id) }}>
